...
<aside class="main-sidebar sidebar-green-primary elevation-4">
    <!-- Brand Logo -->
    <a href="" class="">
        <span class="brand-text font-weight-light"><h1>RS.HEALTY</h1></span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="../dist/img/me.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="../profile.php" class="d-block">Ifan fdl</a>
            </div>
        </div>
